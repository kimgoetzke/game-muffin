...
namespace CaptainHindsight.UI
{
  public class MDialogueTrigger : MonoBehaviour
  {
    ...
    [SerializeField] [ShowIf("triggerDialogue")]
    private QuestGiver questGiver;

    private void Awake()
    {
      if (triggerDialogue == true && questGiver == null)
        Helper.LogError(
    ...
    // This method is used by the Indicator prefab which is attached to the Interactable game object
    // of an NPC. It allows the in-game button to interact with an NPC to be triggered by the mouse
